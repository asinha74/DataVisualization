function termController($scope, $http) {
  ...
  $scope.prepareBackTerms = function(data) {
    $scope.backTerms = data.ethersourceBackgroundAssociations.backgroundAssociations;
    $scope.normalizeWeights($scope.backTerms, 'occurrenceCount', 0.75, 1.5);
  };

  // Loop over the fetched terms
...
// Hard coded for now for the development box
  $scope.timestamp = "2014-01-15 00:00:00 CEST";
}
